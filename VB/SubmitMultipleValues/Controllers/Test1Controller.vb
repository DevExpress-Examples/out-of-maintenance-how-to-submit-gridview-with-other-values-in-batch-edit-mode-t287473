...
Namespace SubmitMultipleValues.Controllers
	Public Class Test1Controller
		...
		End Function
		Public Function GridViewCustomActionUpdate(ByVal mainModel As MainModel) As ActionResult
		...
		Public Function UpdateAllValues(ByVal batchValues As MVCxGridViewBatchUpdateValues(Of GridDataItem, Integer), ByVal mainModel As MainModel) As Boolean
		...
		End Function
		Public Function BatchUpdatePartial(ByVal batchValues As MVCxGridViewBatchUpdateValues(Of GridDataItem, Integer), ByVal mainModel As MainModel) As ActionResult
