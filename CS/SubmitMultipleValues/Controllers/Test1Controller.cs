...
namespace SubmitMultipleValues.Controllers
{
    public class Test1Controller : Controller
    {
        ...
        public ActionResult GridViewCustomActionUpdate(MainModel mainModel)
        {
        ...
        public ActionResult BatchUpdatePartial(MVCxGridViewBatchUpdateValues<GridDataItem, int> batchValues, MainModel mainModel)
        {
